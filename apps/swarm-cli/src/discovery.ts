 ...
 *
 * Discovers running OpenCode servers by scanning for listening ports
 * and verifying they respond to /project/current
 */
 ...
 * Returns empty array if lsof not available or no servers found
 */
